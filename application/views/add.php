...
<head>
	...
	<script type="text/javascript" src="<?php echo url::base(); ?>modules/markitup/jquery.markitup.pack.js"></script>
	<script type="text/javascript" src="<?php echo url::base(); ?>modules/markitup/sets/bbcode/set.js"></script>
	<link rel="stylesheet" type="text/css" href="<?php echo url::base(); ?>modules/markitup/skins/simple/style.css" />
	<link rel="stylesheet" type="text/css" href="<?php echo url::base(); ?>modules/markitup/sets/bbcode/style.css" />  
	<script type="text/javascript">                                         
		// we will add our javascript code here   
		$(document).ready(function() {
			// do stuff when DOM is ready
			$("#content div.addlinkform .form_description").markItUp(mySettings);
